...
/*public final class ChatFloatingTopicsPanel: Component {
    ...
    private final class VerticalAllItemComponent: Component, AllItemComponent {
        let isSelected: Bool
        let kind: ChatFloatingTopicsPanel.Kind
        let theme: PresentationTheme
        let strings: PresentationStrings
        let action: (() -> Void)?
        
        init(isSelected: Bool, kind: ChatFloatingTopicsPanel.Kind, theme: PresentationTheme, strings: PresentationStrings, action: (() -> Void)?) {
            self.isSelected = isSelected
            self.kind = kind
            self.theme = theme
            self.strings = strings
    ...
    public final class View: UIView {
        ...
        func update(component: ChatFloatingTopicsPanel, availableSize: CGSize, state: EmptyComponentState, environment: Environment<EnvironmentType>, transition: ComponentTransition) -> CGSize {
